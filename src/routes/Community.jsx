      ...
      <section className="containerCommunity">
        <div className="contentCommunity">
          <div className="headingContent">
            ...
            <p>
              Kalian diundang!{" "}
              <span>Forum diskusi Animu bisa digunakan untuk semua orang.</span>
            </p>
            <p>
              Cari dulu!{" "}
              <span>
                Sebelum kalian post pertanyaan atau topik pembicaraan kalian
                bisa searching dulu apakah pertanyaan atau topik pembicaraan
                kalian sudah ada atau belum
              </span>
            </p>
          </div>
          ...
          <div className="mainContentCommunity">
            ...
            <div className="subHeadingDiscussion">
              ...
              <Link to="/start-discussion">
                <button className="start-discuss">Start New Discussion</button>
              </Link>
            </div>
